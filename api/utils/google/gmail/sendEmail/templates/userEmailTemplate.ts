...
<div style="font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;">
  <table className="body" cellspacing="0" cellpadding="0" align="center" style="margin-top:56px; margin-bottom: 48px;">
    <tr style="text-align: center;">
      <td align="center">
        <h1 style="font-size: 30px; line-height: 32px; font-weight: 300; margin: 0 0 8px 0;">Congratulations!</h1>
      </td>
    </tr>
    <tr style="text-align: center;">
      <td align="center">
        <h3 style="font-size: 22px; line-height: 24px; font-weight: 300; margin: 0 0 8px 0;">You've completed My D.R.E.S.S. Profile!</h3>
      </td>
    </tr>
    <tr style="text-align: center;">
      <td align="center">
        <p style="max-width: 400px; font-size: 14px; margin: 20px 0 16px 0;">These results create a template for your personalized wellness routine for each of the 5 Pillars of Health Mastery:</p>
      </td>
    </tr>
    <tr style="height: 8px;"></tr>
    <tr>
      <td>
        <div style="text-align: center; line-height: 0; height: 22px;">
          <span style="font-size: 20px; vertical-align: middle;">&bull;</span><p style="display: inline-block; font-size: 16px; margin:0 8px 0 4px;">Diet</p>
          <span style="font-size: 20px; vertical-align: middle;">&bull;</span><p style="display: inline-block; font-size: 16px; margin: 0 8px 0 4px;">Rest</p>
          <span style="font-size: 20px; vertical-align: middle;">&bull;</span><p style="display: inline-block; font-size: 16px; margin: 0 8px 0 4px;">Exercise</p>
          <span style="font-size: 20px; vertical-align: middle;">&bull;</span><p style="display: inline-block; font-size: 16px; margin: 0 8px 0 4px;">Stress Mastery</p>
          <span style="font-size: 20px; vertical-align: middle;">&bull;</span><p style="display: inline-block; font-size: 16px; margin: 0 0 0 4px;">Supplements</p>
        </div>
      </td>
    </tr>
    <tr>
